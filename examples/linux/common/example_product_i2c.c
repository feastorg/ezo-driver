...
#define EZO_EXAMPLE_I2C_QUERY(send_expr, read_expr) \
  do {                                              \
    result = (send_expr);                           \
    if (result != EZO_OK) {                         \
      return result;                                \
...
ezo_result_t ezo_example_query_info_i2c(ezo_i2c_device_t *device,
...
ezo_result_t ezo_example_print_shared_control_i2c(ezo_i2c_device_t *device,
  ...
  EZO_EXAMPLE_I2C_QUERY(ezo_control_send_name_query_i2c(device, product_id, &hint),
                        ezo_control_read_name_i2c(device, &name));
  EZO_EXAMPLE_I2C_QUERY(ezo_control_send_status_query_i2c(device, product_id, &hint),
                        ezo_control_read_status_i2c(device, &status));
  EZO_EXAMPLE_I2C_QUERY(ezo_control_send_led_query_i2c(device, product_id, &hint),
                        ezo_control_read_led_i2c(device, &led));
  EZO_EXAMPLE_I2C_QUERY(ezo_control_send_protocol_lock_query_i2c(device, product_id, &hint),
...
ezo_result_t ezo_example_print_product_readiness_i2c(ezo_i2c_device_t *device,
                                                     ezo_product_id_t product_id) {
  ezo_timing_hint_t hint;
  ezo_result_t result = EZO_OK;
  ...
  switch (product_id) {
    case EZO_PRODUCT_PH: {
      ...
      EZO_EXAMPLE_I2C_QUERY(ezo_ph_send_temperature_query_i2c(device, &hint),
                            ezo_ph_read_temperature_i2c(device, &temperature));
      EZO_EXAMPLE_I2C_QUERY(ezo_ph_send_calibration_query_i2c(device, &hint),
                            ezo_ph_read_calibration_status_i2c(device, &calibration));
      EZO_EXAMPLE_I2C_QUERY(ezo_ph_send_slope_query_i2c(device, &hint),
                            ezo_ph_read_slope_i2c(device, &slope));
      EZO_EXAMPLE_I2C_QUERY(ezo_ph_send_extended_range_query_i2c(device, &hint),
    ...
    case EZO_PRODUCT_ORP: {
      ...
      EZO_EXAMPLE_I2C_QUERY(ezo_orp_send_calibration_query_i2c(device, &hint),
                            ezo_orp_read_calibration_status_i2c(device, &calibration));
      EZO_EXAMPLE_I2C_QUERY(ezo_orp_send_extended_scale_query_i2c(device, &hint),
    ...
    case EZO_PRODUCT_EC: {
      ...
      EZO_EXAMPLE_I2C_QUERY(ezo_ec_send_output_query_i2c(device, &hint),
                            ezo_ec_read_output_config_i2c(device, &output_config));
      EZO_EXAMPLE_I2C_QUERY(ezo_ec_send_temperature_query_i2c(device, &hint),
                            ezo_ec_read_temperature_i2c(device, &temperature));
      EZO_EXAMPLE_I2C_QUERY(ezo_ec_send_probe_k_query_i2c(device, &hint),
                            ezo_ec_read_probe_k_i2c(device, &probe_k));
      EZO_EXAMPLE_I2C_QUERY(ezo_ec_send_tds_factor_query_i2c(device, &hint),
                            ezo_ec_read_tds_factor_i2c(device, &tds_factor));
      EZO_EXAMPLE_I2C_QUERY(ezo_ec_send_calibration_query_i2c(device, &hint),
    ...
    case EZO_PRODUCT_DO: {
      ...
      EZO_EXAMPLE_I2C_QUERY(ezo_do_send_output_query_i2c(device, &hint),
                            ezo_do_read_output_config_i2c(device, &output_config));
      EZO_EXAMPLE_I2C_QUERY(ezo_do_send_temperature_query_i2c(device, &hint),
                            ezo_do_read_temperature_i2c(device, &temperature));
      EZO_EXAMPLE_I2C_QUERY(ezo_do_send_salinity_query_i2c(device, &hint),
                            ezo_do_read_salinity_i2c(device, &salinity));
      EZO_EXAMPLE_I2C_QUERY(ezo_do_send_pressure_query_i2c(device, &hint),
                            ezo_do_read_pressure_i2c(device, &pressure));
      EZO_EXAMPLE_I2C_QUERY(ezo_do_send_calibration_query_i2c(device, &hint),
    ...
    case EZO_PRODUCT_RTD: {
      ...
      EZO_EXAMPLE_I2C_QUERY(ezo_rtd_send_scale_query_i2c(device, &hint),
                            ezo_rtd_read_scale_i2c(device, &scale));
      EZO_EXAMPLE_I2C_QUERY(ezo_rtd_send_calibration_query_i2c(device, &hint),
                            ezo_rtd_read_calibration_status_i2c(device, &calibration));
      EZO_EXAMPLE_I2C_QUERY(ezo_rtd_send_logger_query_i2c(device, &hint),
                            ezo_rtd_read_logger_i2c(device, &logger));
      EZO_EXAMPLE_I2C_QUERY(ezo_rtd_send_memory_query_i2c(device, &hint),
    ...
    case EZO_PRODUCT_HUM: {
      ...
      EZO_EXAMPLE_I2C_QUERY(ezo_hum_send_output_query_i2c(device, &hint),
                            ezo_hum_read_output_config_i2c(device, &output_config));
      EZO_EXAMPLE_I2C_QUERY(ezo_hum_send_temperature_calibration_query_i2c(device, &hint),
                            ezo_hum_read_temperature_calibration_status_i2c(device,
                                                                            &calibration));
